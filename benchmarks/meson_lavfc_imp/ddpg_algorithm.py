...
class DDPGOffloadingAlgorithm(BaseAlgorithmModule):
    ...
    def scheduleOffloading(self, env: AirFogSimEnv):
        ...
        # action: [m1 * max_tasks]
        action, action_logits = self.DDPG_Agent.select_action(task_node_np, task_data_np, compute_node_np, task_mask, compute_node_mask)
    ...
    def scheduleCommunication(self, env: AirFogSimEnv):
        ...
        all_offloading_task_infos = all_offloading_task_infos[:20]
