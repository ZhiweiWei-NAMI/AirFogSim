...
if cuda_num > 0:
    ...
    MADDPG_device = f"cuda:{cuda_list[cuda_num - 6]}"
else:
    MADDPG_device = "cpu"
...
def parseMADDPGTrainArgs():
    ...
    parser.add_argument('--var', type=float, default=0.2)  # 动作探索随机噪声
    ...
    def updatePPExperience(self, env: AirFogSimEnv):
        ...
        for idx in range(self.max_n_UAVs):
            ...
            if UAV_id in active_UAV_ids:
                ...
                reward = trans_data*10 + sensing_data*100 - energy_consumption
