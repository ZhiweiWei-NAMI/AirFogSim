...
class TkinterLayout(tk.Tk, BaseLayout):
    ...
    def update_visualization(self):
        ...
        self.draw_canvas_images(self.canvas_vehicle_images, self.vehicle_positions_in_pixel, self.car_images, "vehicle", directions = self.vehicle_directions)
    ...
    def draw_links(self):
        ...
        for idx, links in enumerate(all_links):
            ...
            for tx_idx, rx_idx in zip(*np.where(links)):
                ...
                self.canvas.create_text(mid_pos_x, mid_pos_y, text="{} Mbps".format(round(rate, 2)), anchor=tk.CENTER, tags=f"{type_str[idx]}_link")
    ...
    def clear_links(self):
        self.canvas.delete("v2v_link", "v2i_link", "v2u_link", 'u2u_link', 'u2i_link', 'u2v_link', 'i2v_link', 'i2u_link', 'i2i_link')
